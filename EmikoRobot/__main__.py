...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an anime-theme management bot [✨](https://telegra.ph/file/bcc47db0d13c5127323cc.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    ...
    [
        InlineKeyboardButton(
         ...
         InlineKeyboardButton(
            text="Support Group", url=f"t.me/WizardBotHelper"),
    ],
]
     InlineKeyboardButton(
            text="Upated Channel", url=f"t.me/Wizard_Bots"),
    ],
]
